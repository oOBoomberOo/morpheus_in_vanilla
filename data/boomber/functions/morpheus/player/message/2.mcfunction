...
tellraw @a[tag=!global.ignore, tag=!global.ignore.gui] [{"selector": "@s", "color": "yellow"}, {"text": " is sleeping - ", "color": "yellow"}, {"score": {"name": "#ratio.needed", "objective": "bb.mp.var"}, "color": "yellow"}, {"text": "%", "color": "yellow"}]
