...
execute if score #bb.mp.sleep_timer bb.variable >= #sleep_time bb.gamerule if entity @e[tag=boomber.morpheus.is_sleep] if score #bb.mp.sleep_player bb.variable >= #bb.mp.player_needed bb.variable run function boomber:morpheus/event/skip_the_night/skip_the_night
